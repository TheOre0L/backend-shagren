...
export class Cdek extends EventEmitter<ApiWebhook.EventMap> {
  ...
  getRegions(
    params?: ApiRequest.GetRegions,
  ): Promise<ApiResponse.GetRegions[]> {
  ...
  updateOrder(
    params: ApiRequest.UpdateOrder,
  ): Promise<ApiResponse.UpdateOrder> {
  ...
  createOrderReceipt(
    params: ApiRequest.CreateOrderReceipt,
  ): Promise<ApiResponse.CreateOrderReceipt> {
  ...
  createBarcodeCP(
    params: ApiRequest.CreateBarcodeCP,
  ): Promise<ApiResponse.CreateBarcodeCP> {
  ...
  addDeliveryAppointment(
    params: ApiRequest.AddDeliveryAppointment,
  ): Promise<ApiResponse.AddDeliveryAppointment> {
  ...
  getDeliveryAppointment(
    uuid: string,
  ): Promise<ApiResponse.GetDeliveryAppointment> {
  ...
  addPrealert(
    params: ApiRequest.AddPrealert,
  ): Promise<ApiResponse.AddPrealert> {
  ...
  getPassportData(
    params: ApiRequest.GetPassportData,
  ): Promise<ApiResponse.GetPassportData> {
  ...
  getCashboxCheck(
    params: ApiRequest.GetCashboxCheck,
  ): Promise<ApiResponse.GetCashboxCheck> {
  ...
  calculatorByTariff(
    params: ApiRequest.CalculatorByTariff,
  ): Promise<ApiResponse.CalculatorByTariff> {
  ...
  getFinishedOrders(
    params: ApiRequest.GetFinishedOrders,
  ): Promise<ApiResponse.GetFinishedOrders> {
  ...
  createClientReturn(
    params: ApiRequest.CreateClientReturn,
  ): Promise<ApiResponse.CreateClientReturn> {
